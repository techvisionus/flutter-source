...
import 'package:flutter_my_page/gen_a/A.dart';
...
class ImageWidget extends StatefulWidget {
  ...
  ///Use to process image before display
...
class MyIOFileSystem implements FileSystem {
  ...
  Future<File> createFile(String name) async {
    ...
    //Fix the bug that the file does not exist and an error is reported when the cache is deleted
    //Solve the bug of flutter_cache_manager 2.1.0 version flutter_cached_network_image 2.5.0 version
